<?php include("inc_header.php")?>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                $q1    = mysqli_query($koneksi,$sql1);
                $total = mysqli_num_rows($sq1);
                $page  = ceil($total / $per_halaman);
                $nomor = $mulai + 1;
                $sql1  = $sql1." order by id desc limit $mulai,$per_halaman";

                $q1    = mysqli_query($koneksi, $sql1);
                
                while($r1 = mysgli_fetch_array($q1)){
                    ?>
                    <tr>
                    ...
                    <td>
                        ...
                        <a href="halaman.php?op=delete&id=<?php echo $r1['id']?>" onclik="return confirm('Apakah yakin mau hapus data bro?')">
